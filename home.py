...
class homePage(Ui_MainWindow):
    ...
    def homeUI(self):
        ...
        conn.close()'''
        #self.homeBox.resize()
        self.homeBox.setGeometry(0,60,QApplication.desktop().width(), QApplication.desktop().height())#面板像素大小
        ...
        self.source.move(0,self.advertisementLab.height() +self.advertisementLab.y())#来源框定位
        self.source.window =self        #绑定self 为来源框window
